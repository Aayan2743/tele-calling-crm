                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-8">					
                                <div class="d-flex align-items-center flex-wrap row-gap-2 justify-content-sm-end mb-3 mb-sm-0">
                                    <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#offcanvas_add"><i class="ti ti-square-rounded-plus me-2"></i>Add New Followups</a>
                                </div>
                            </div>
                        </div>
                        <!-- /Search -->
                    ...
                    <div class="card-body">					
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
                            <div class="sort-dropdown drop-down task-drops">
                                <a href="javascript:void(0);" class="dropdown-toggle"  data-bs-toggle="dropdown">All Followups </a>
                                <div class="dropdown-menu  dropdown-menu-start">
                                    <ul>
                                        <li>
                                            <a href="{{url('followups')}}">
                                                <i class="ti ti-dots-vertical"></i>All Followups
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{url('followups-important')}}">
                                                <i class="ti ti-dots-vertical"></i>Important
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{url('followups-completed')}}">
                                        ...
                                        <div class="filter-set-view">
                                            ...
                                            <div class="filter-reset-btns">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <a href="{{url('followups')}}" class="btn btn-primary">Filter</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
